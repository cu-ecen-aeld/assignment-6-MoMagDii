...
SRC_URI = "git://git@github.com/cu-ecen-aeld/assignment-7-MoMagDii.git;protocol=ssh;branch=master"
...
# KERNEL_VERSION = "5.15.108-yocto-standard"
# KERNEL_VERSION = "${@oe_runmake(['uname', '-r'], d)}"
